...
/***/ function(module, exports, __webpack_require__) {
	...
	var Section = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement('div', { className: this.props.sectionClassName + (this.props.className ? ' ' + this.props.className : ''), id: this.props.id, style: sectionStyle }, alignVertical ? this._renderVerticalAlign(children) : children);
	  },
	  ...
	  _renderVerticalAlign: function _renderVerticalAlign(children) {
	    ...
	    return _react2['default'].createElement('div', { style: verticalAlignStyle }, children);
	  }
	});
